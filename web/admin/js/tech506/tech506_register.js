...
Tech506.Register = {
    ...
    registerCall: function() {
        //Revisar si el Cliente ya se busc�
    ...
    areRequiredFieldsValid: function() {
        ...
        if ($securityCode.length < 4) {
            Tech506.showErrorMessage("El código de seguridad debe contener al menos 4 caracteres");
            return false;
        }
        return true;
    },
    ...
    validatePhone: function() {
        ...
        if((phoneValue.length < 7)) {
            Tech506.showErrorMessage("El n�mero de tel�fono debe tener al menos 7 n�meros");
            return false;
        }
        return true;
    }
